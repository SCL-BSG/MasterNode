...
/**
 * Split SocietyG command line into a list of arguments. Aims to emulate \c bash and friends.
 *
    ...
    banTableContextMenu(0)
{
    ...
    ui->openSocietyGConfigfileButton->setIcon(QIcon(":/icons/export"));
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SocietyG RPC console.") + "<br>" +
...
void RPCConsole::on_openSocietyGConfigfileButton_clicked()
{
    GUIUtil::openSocietyGConfigfile();
}
