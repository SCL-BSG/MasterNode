...
private slots:
    ...
    QString BuySocietyG(QString OrderType, double Quantity, double Rate);
    QString SellSocietyG(QString OrderType, double Quantity, double Rate);
